...
/* Template Name: Law Search Template */
...
if( class_exists( 'SearchWP' ) ) {
	...
	$supplementalSearchEngineName = 'search_law'; // taken from the SearchWP settings screen
...
get_header(); ?>
	...
	<div class="section-banner"	style="background:url('<?php echo $thumbnail; ?>') no-repeat center center;">
		<header class="entry-header">
			<h1 class="entry-title">Regula&ccedil;&atilde;o & Legisla&ccedil;&atilde;o</h1>
		</header><!-- .entry-header -->
	</div>
