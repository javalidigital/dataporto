...
/* Template Name: News Search Template */
...
if( class_exists( 'SearchWP' ) ) {
	...
	$supplementalSearchEngineName = 'search_news'; // taken from the SearchWP settings screen
...
get_header(); ?>
	...
	<div class="section-banner"	style="background:url('<?php echo $thumbnail; ?>') no-repeat center center;">
		<header class="entry-header">
			<h1 class="entry-title">Not&iacute;cias Comentadas</h1>
		</header><!-- .entry-header -->
	</div>
